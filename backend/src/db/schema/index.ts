...
export const productRequiredAttributes = pgTable(
  // dùng để quản lý các thuộc tính bắt buộc cho sản phẩm
...
export const categoriesRelations = relations(categories, ({ many, one }) => ({
  parent: one(categories, {
    ...
    relationName: "parentChild", // 👈 đặt tên cho quan hệ
  }),
  children: many(categories, {
    relationName: "parentChild", // 👈 phải trùng tên ở phía đối ứng
  }),
...
export const productRequiredAttributesRelations = relations(
  productRequiredAttributes,
  ({ one }) => ({
    product: one(products, {
      fields: [productRequiredAttributes.productId],
      references: [products.id],
    }),
    attribute: one(attributes, {
      fields: [productRequiredAttributes.attributeId],
      references: [attributes.id],
    }),
  })
);
