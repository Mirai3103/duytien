				...
				<div className="container mx-auto px-4 py-8 max-w-4xl">
					...
					<Card>
						...
						<CardContent className="prose dark:prose-invert max-w-none">
							...
							<p>
								Chúng tôi thu thập thông tin mà bạn cung cấp trực tiếp cho chúng
								tôi, bao gồm:
							</p>
							<ul>
								<li>Họ và tên</li>
							...
							<ul>
								<li>
									<strong>Nhà cung cấp dịch vụ:</strong> Để hỗ trợ hoạt động
									kinh doanh của chúng tôi (vận chuyển, thanh toán, v.v.)
								</li>
								<li>
								...
								<li>
									...
									hoặc an toàn của chúng tôi và người dùng
								</li>
							</ul>
							...
							<p>
								...
								hợp để bảo vệ thông tin cá nhân của bạn khỏi truy cập, sửa đổi,
								tiết lộ hoặc phá hủy trái phép.
							</p>

							<h2>5. Cookies</h2>
							<p>
								Website của chúng tôi sử dụng cookies để cải thiện trải nghiệm
								người dùng. Cookies giúp chúng tôi hiểu cách bạn sử dụng website
							...
							<p>
								...
								thiết để thực hiện các mục đích đã nêu trong chính sách này, trừ
								khi pháp luật yêu cầu hoặc cho phép thời gian lưu trữ lâu hơn.
							</p>

							<h2>8. Chuyển giao dữ liệu quốc tế</h2>
							<p>
								Thông tin của bạn có thể được chuyển đến và lưu trữ tại các máy
								chủ ở ngoài quốc gia của bạn. Chúng tôi sẽ đảm bảo rằng việc
								chuyển giao này tuân thủ các quy định về bảo vệ dữ liệu.
							</p>
							...
							<p>
								...
								đăng chính sách mới trên trang này.
							</p>
