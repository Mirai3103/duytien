...
import { ArrowLeft, CreditCard, Truck, MapPin, Phone, User, Mail, ChevronRight, Wallet, Building2, CheckCircle2 } from 'lucide-react'
...
function RouteComponent() {
  ...
  const shippingFee = shippingMethod === 'express' ? 50000 : shippingMethod === 'standard' ? 30000 : 0
                  ...
                  {paymentMethod === 'bank' && (
                    <div className="mt-4 p-4 bg-muted rounded-lg space-y-2">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        <p>Chủ tài khoản: <span className="font-semibold">CÔNG TY TNHH ABC</span></p>
