              ...
              {activeCategory.id === "phone" && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-6 gap-3">
                      {activeCategory.tablets?.slice(0, 9).map((tablet, idx) => (
                        <Link
                          key={idx}
                          to="/search"
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      {activeCategory.hotTablets?.slice(0, 8).map((tablet, idx) => (
                        <Link
                          key={idx}
                          to="/search"
                  ...
                  {/* Price Ranges */}
                  <div>
                    <h3 className="font-bold text-lg mb-4">Mức giá điện thoại</h3>
