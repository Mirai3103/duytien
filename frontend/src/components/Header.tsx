      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="cursor-pointer mr-3" onClick={() => navigate({ to: "/" })}>
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" className="relative  text-white hover:bg-primary-dark hover:text-white gap-2">
              <User size={24} />
              <span className="font-medium">Đăng nhập</span>
            </Button>
            <Button variant="ghost" size="icon" className="relative text-white hover:bg-primary-dark hover:text-white">
