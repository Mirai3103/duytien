...
const categories = [
	{
		...
		color: "text-blue-500",
		image:
			"https://cdn2.fptshop.com.vn/unsafe/360x0/filters:format(webp):quality(75)/dien_thoai_icon_cate_05347c5136.png",
	},
	{
		icon: Laptop,
		name: "Laptop",
	...
	},
	{
		...
		image:
			"https://cdn2.fptshop.com.vn/unsafe/360x0/filters:format(webp):quality(75)/phu_kien_ic_cate_ecae8ddd38.png",
	},
	{
		icon: Watch,
		name: "Đồng hồ",
		...
		image:
			"https://cdn2.fptshop.com.vn/unsafe/360x0/filters:format(webp):quality(75)/dong_ho_icon_cate_d8bc66c8e7.png",
	},
	{
		icon: Gamepad2,
		name: "Gaming",
	...
	},
	{
		...
		color: "text-pink-500",
		image:
			"https://cdn2.fptshop.com.vn/unsafe/360x0/filters:format(webp):quality(75)/2024_1_29_638421266235563489_camera-insta360-ace-dd.jpg",
	},
	{
		icon: Smartphone,
		name: "Điện thoại",
